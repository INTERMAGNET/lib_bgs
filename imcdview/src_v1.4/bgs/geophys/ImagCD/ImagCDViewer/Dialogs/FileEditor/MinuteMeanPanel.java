 ...
 */
public class MinuteMeanPanel extends JPanel 
{
    ...
    private class DataModel extends AbstractTableModel
    {
        ...
        public Object getValueAt(int row, int column)
        {
            ...
            return Integer.toString (data_day.getMinuteData(column -1, row));
        }
        ...
        public void setValueAt(Object object, int row, int column)
        {
            ...
            try
            {
                ...
                data_day = data_file.getDataDay (data_file.getDayDisplayed());
                data_day.setMinuteData(value,  column -1, row);
    ...
    /** Creates a new instance of MinuteMeanPanel
      * @param data_file the data file that this panel displays */
    public MinuteMeanPanel(ImagCDFile data_file, boolean editable) 
    {
