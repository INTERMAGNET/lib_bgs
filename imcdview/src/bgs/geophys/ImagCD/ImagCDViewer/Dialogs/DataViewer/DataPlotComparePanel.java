/*
 * DataPlotComparePanel.java
 *
 * Created on 11 April 2002, 14:50
 */

/**
 * Panel for plotting comparison data between two observatories
 *
 * @author fmc
 * @version
 */
...
public class DataPlotComparePanel extends DataPlotPanel
{

    /********************************************************************
     * Creates a new empty instance of PlotPanel used for initialisation
     ********************************************************************/
    public DataPlotComparePanel ()
    {
                        ...
                        DisplayData data_list, int time_period)
    {
        ...
        data = data_list.getDiffData();
        stats = data_list.getDifferenceStats();
        
        // draw the magnetogram
        makeTitle ("Comparison Viewer: ", obsy_name, compare_obsy_name, true, year, month, day, time_period);
        ...
        if (data == null) magnetogram.addSubtitle("The comparison observatory does not have data for this date.");
        else
        {
            switch (time_period)
            {
