...
public class CDFE_EditvVarEntryTableScrollPane extends JScrollPane implements CDFConstants {

    private Variable var;

    private CDFE_EditvVarEntryTableScrollPane aTableScrollPane;
    ...
    CDFE_EditvVarEntryTableScrollPane(CDFE_VariablePanel varPanel) {
...
//                return true;
        ...
        public void setValueAt(Object value, int row, int col) {
		    ...
		    Toolkit.getDefaultToolkit().beep();
                ...
                if (col == 1) applyValue(oldone, value, row, col);
//                if (col == 2) checkNumElem(value, row);
                if (col == 2) value = checkValue(value, row);
