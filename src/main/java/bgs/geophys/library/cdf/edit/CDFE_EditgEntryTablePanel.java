...
/**
 *  This class creates the table showing all entries for a given global attribute 
 *  from a CDF to allow user to edit
 */

public class CDFE_EditgEntryTablePanel extends JPanel implements CDFConstants {

    static final long serialVersionUID = 1L;

    private Attribute selectedAttr;

    private CDFE_EditgEntryTablePanel aTablePanel;
    ...
    private static String[] headcol = { "Entry", "Data Type", "Entry Data" };

    CDFE_EditgEntryTablePanel(CDFE_EditAttrEntryPanel entryPanel) {

	aTablePanel = this;
	myEditor = entryPanel.getMyEditor();
	selectedAttr = entryPanel.getSelectedAttr();
...
//          myModel.addTableModelListener(this);
          table.setPreferredScrollableViewportSize(new Dimension(520, 210));
	     ...
	     if (i == 0) column.setPreferredWidth(40);
             ...
             if (i == 2) column.setPreferredWidth(370);
          }
	  ...
	  if (dataObject != null)
        ...
        Object checkValue(Object newone, int row) {
            ...
            if (dataType.equals("CDF_BYTE") || dataType.equals("CDF_INT1")) {
                ...
                formatter.setParseIntegerOnly(false);
                try {
                    return (String) "" + formatter.parse((String)newone);
                } catch (ParseException e) {
                  return null;
                }
 ...
 */
    ...
    private void buildDataTable() {
        ...
        Vector entries;
        try {
          entries = selectedAttr.getEntries();
        } catch (CDFException ex) { entries = null;}
	...
	if (entries != null) {
	  ...
	  dataObject = new Object[entryNum][headcol.length];
	  ...
	  int jj = -1;
		...
		jj++;
	    	...
	    	numElem = en.getNumElements();
// Modifications: SMF
//                try {
	      	  value = en.getData();
// Modifications: SMF
//	      	} catch (CDFException ex) {} 
                dataObject[jj][0] = "" + (en.getID() + 1);
